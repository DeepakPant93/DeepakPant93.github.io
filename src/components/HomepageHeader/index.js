      ...
      >
        ...
        >
          ...
          >
            ...
            <h2>
                AWS Certified Solution Architect| Lead Technical Architect | Certified Salesforce AI Associate
            </h2>

                <h3>Ex Fidelity | Ex Lumen</h3>
            ...
            >
              <Grid item>
                <Link
                  className="button"
                  to="https://github.com/DeepakPant93"
                  style={{ padding: "1rem" }}
                >
              ...
              <Grid item>
                <Link
                  className="button"
                  to="https://www.linkedin.com/in/deepak-pant-014787115/"
                  style={{ padding: "1rem" }}
                >
